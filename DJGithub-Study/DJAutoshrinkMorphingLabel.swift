//
//  DJAutoshrinkMorphingLabel.swift
//  DJGithub-Study
//
//  Created by linxian on 16/7/29.
...
class DJAutoshrinkMorphingLabel: LTMorphingLabel {
    ...
    private func adjustFontSizeToFitText(newText: String){
        ...
        if frame.width < desiredWidth {
            ...
            font = UIFont(name: originalFont.fontName, size: floor(originalFont.pointSize * scaleFactor))
        }
        else{
            // Revert to normal
            font = originalFont
